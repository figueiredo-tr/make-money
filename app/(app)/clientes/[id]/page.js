    ...
    <div className="px-8 py-8 max-w-5xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
        ...
        <Card>
          ...
          <p
            className={`font-mono text-xl ${resumo.atrasadas > 0 ? "text-wine" : "text-ink"}`}
          >
            {resumo.atrasadas}
          </p>
        </Card>
      ...
      {emprestimos.length === 0 ? (
        <Card>
          <p className="text-sm text-faint py-2">
            Esse associado ainda não tem empréstimos registrados.
          </p>
        </Card>
      ) : (
            ...
            return (
              <Card key={emp.id}>
                <div className="flex items-start justify-between flex-wrap gap-3 mb-4">
                  <div>
                    ...
                    <p className="text-xs text-muted mt-1">
                      ...
                      {emp.taxa_juros}% · {emp.numero_parcelas}x{" "}
                ...
                {parcelasDoEmprestimo.length === 0 ? (
                  <p className="text-sm text-faint py-2">
                    Nenhuma parcela gerada pra esse empréstimo.
                  </p>
                ) : (
